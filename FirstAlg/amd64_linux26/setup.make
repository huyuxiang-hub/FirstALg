...
use ROOT v0 Externals (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/ExternalInterface)
use Python v0 Externals (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/ExternalInterface)
use Boost v0 Externals (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/ExternalInterface)
use SniperPolicy v0  (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use XmlObjDesc v0  (/junofs/users/huyuxiang/juno/offline) (no_auto_imports)
use BaseEvent v0 DataModel (/junofs/users/huyuxiang/juno/offline)
use SniperKernel v2  (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use RootWriter v0 SniperSvc (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use DummyAlg v0 Examples (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use PyDataStore v0 SniperUtil (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use HelloWorld v1 Examples (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use DataBuffer v0 SniperUtil (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use SniperRelease v2  (/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper)
use JunoTimer v0 Utilities (/junofs/users/huyuxiang/juno/offline)
use EDMUtil v0 DataModel (/junofs/users/huyuxiang/juno/offline)
use SimEventV2 v0 DataModel (/junofs/users/huyuxiang/juno/offline)
use DataRegistritionSvc v0 DataModel (/junofs/users/huyuxiang/juno/offline)
use PhyEvent v0 DataModel (/junofs/users/huyuxiang/juno/offline)
use EvtNavigator v0 DataModel (/junofs/users/huyuxiang/juno/offline)
use RootIOUtil v0 RootIO (/junofs/users/huyuxiang/juno/offline)
use RootIOSvc v0 RootIO (/junofs/users/huyuxiang/juno/offline)
use BufferMemMgr v0 CommonSvc (/junofs/users/huyuxiang/juno/offline)
----------> tags
...
----------> CMTPATH
# Add path /junofs/users/huyuxiang/juno/offline from initialization
# Add path /cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/sniper from ProjectPath
# Add path /cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre2/ExternalInterface from ProjectPath
