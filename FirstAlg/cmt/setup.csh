...
${CMTROOT}/mgr/cmt setup -csh -pack=FirstAlg -version=v0 -path=/junofs/users/huyuxiang/juno/offline/Examples  -no_cleanup $* >${cmtFirstAlgtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt setup -csh -pack=FirstAlg -version=v0 -path=/junofs/users/huyuxiang/juno/offline/Examples  -no_cleanup $* >${cmtFirstAlgtempfile}"
