...
${CMTROOT}/mgr/cmt setup -sh -pack=FirstAlg -version=v0 -path=/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno/offline/Examples  -no_cleanup $* >${cmtFirstAlgtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/mgr/cmt setup -sh -pack=FirstAlg -version=v0 -path=/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno/offline/Examples  -no_cleanup $* >${cmtFirstAlgtempfile}"
  cmtsetupstatus=2
